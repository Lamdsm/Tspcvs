...
Lưu ý:
- `npm install` sẽ cài sẵn Netlify CLI vào `node_modules`, nên không cần cài `netlify` global trước khi chạy script.
- Lệnh trên vẫn yêu cầu bạn đăng nhập Netlify CLI hoặc cung cấp token môi trường tương ứng.
